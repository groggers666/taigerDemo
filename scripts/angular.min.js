...
<head>
  ...
  <script id="angularScript" src="https://ajax.googleapis.com/ajax/libs/angularjs/1.7.8/angular.min.js"></script>
...
<body ng-controller="AppController" class="homepage">
          ...
          <ul class="nav">
            ...
            <li class="dropdown" uib-dropdown>
              ...
              <ul class="dropdown-menu" uib-dropdown-menu>
                ...
                <li><a href="https://code.angularjs.org/">Download</a></li>
              </ul>
            </li>
            <li class="dropdown" uib-dropdown>
  ...
  <div role="main">
    <div class="stage-container">
      <div class="hero">
        ...
        <div class="text-center">
          <a href="https://angular.io" target="_blank" class="button button-large button-primary has-shield has-shadow">
            Try the New Angular
            <sup class="badge-new">New</sup>
          </a>
        </div>

        <div class="text-center">
          <a class="button button-large button-secondary has-shield download-btn" href="" ng-click="showDownloadModal()">
            Download AngularJS
          </a>
        </div>
    ...
    <div class="announcement-bar">
      <ul>
        <li>
          <a class="button button-small button-plain" href="https://github.com/angular/angular.js">
            <i class="icon-github-sign icon-large"></i> View on GitHub
          </a>
        </li>
    ...
    <div class="container about-container">
      <div class="row first">
        <div class="span4">
          <h3 class="text-display-1">Why AngularJS?</h3>
          <p class="text-body">
        ...
        <div class="span4">
          <h3 class="text-display-1">Alternatives</h3>
          <p class="text-body">
        ...
        <div class="span4">
          <h3 class="text-display-1">Extensibility</h3>
          <p class="text-body">
  ...
  <div role="main" class="container">
    <h3 class="text-display-1" id="the-basics">The Basics</h3>
    <div class="row example">
      <div class="span8 app-source" app-source="hello.html" annotate="hello.annotation"></div>
      <div class="span4">
        <span hint></span>
        <span class="pull-right" plnkr="hello.html"></span>
    ...
    <h3 class="text-display-1" id="add-some-control">Add Some Control</h3>
    <div class="row">
      <div class="span4">
        <h4 class="text-title">Data Binding</h4>
        <p class="text-body">
      ...
      <div class="span4">
        <h4 class="text-title">Controller</h4>
        <p class="text-body">
      ...
      <div class="span4">
        <h4 class="text-title">Plain JavaScript</h4>
        <p class="text-body">
    ...
    <div class=" row example">
      ...
      <div class="span4">
        <span hint></span>
        <span class="pull-right" plnkr="todo.html todo.js todo.css" module="todoApp"></span>
        <div class="tabs-spacer"></div>
        <div app-run="todo.html" module="todoApp" class="well"></div>
        <h4 class="text-title">Watch as we build this app</h4>
    ...
    <div class="modal hide fade" style="display: none;" id="videoModal">
      <div class="modal-header">
        ...
        <h4 class="text-title">AngularJS Todo Tutorial</h4>
      </div>
    ...
    <div class="row">
      <div class="span4">
        <h3 class="text-title">Directives</h4>
        <p class="text-body">
      ...
      <div class="span4">
        <h3 class="text-title">Reusable Components</h4>
        <p class="text-body">
      ...
      <div class="span4">
        <h3 class="text-title">Localization</h4>
        <p class="text-body">
    ...
    <div class=" row example">
      ...
      <div class="span4">
        <span hint></span>
        <span class="pull-right" plnkr="tabs.html components.js app.js" module="app"></span>
        <div class="tabs-spacer"></div>
        <h4>Locale: US</h4>
    ...
    <div class="row">
      <div class="span6">
        <h4 class="text-title">Injectable</h4>
        <p class="text-body">
      ...
      <div class="span6">
        <h4 class="text-title">Testable</h4>
        <p class="text-body">
  ...
  <script src="https://code.angularjs.org/1.7.8/i18n/angular-locale_sk.js"></script>
  <script>
    angular.module('ngLocal.sk', [])._configBlocks.push(angular.module('ngLocale')._configBlocks[0]);
  </script>
  <script src="https://code.angularjs.org/1.7.8/i18n/angular-locale_en-us.js"></script>
  <script>
